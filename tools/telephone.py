...
def process_chain(guid, first_node, chain, file):
    ...
    for step_number, step in enumerate(chain):
        ...
        file = process_step(guid, first_node, step_number, step, chain, file)
...
def process_step(guid, first_node, step_number, step, chain, file):
    """
