...
@cli.command()
@click.option("-i", "--input", type=click.Path(dir_okay=False, path_type=Path, readable=True), default="output.json",
...
@cli.command()
@click.option("-i", "--input-dir", type=click.Path(file_okay=False, path_type=Path, readable=True),
              help="directory containing json files to be tested, will recursivel walk", required=True)
@click.option("-o", "--output-dir", type=click.Path(file_okay=False, path_type=Path, writable=True), default="output",
              help="directory to save testing output")
